...
const Navigation = () => {
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 transition-all duration-500 ${
        hasBackground
    ...
    >
      <div className="max-w-350 mx-auto flex items-center justify-between">
        <div className="flex items-center gap-2 sm:gap-4 lg:gap-6">
          <div
            className="flex items-center gap-3 sm:gap-6 text-white/80 text-xs sm:text-sm font-light"
          ...
          >
            <button
              ...
              className={`hover:text-white transition-all duration-300 relative ${
                currentLanguage === "pt" ? "text-white" : "text-white/50"
              }`}
            >
              PT
              {currentLanguage === "pt" && (
            ...
            <button
              ...
              className={`hover:text-white transition-all duration-300 relative ${
                currentLanguage === "en" ? "text-white" : "text-white/50"
              }`}
            >
              EN
              {currentLanguage === "en" && (
        ...
        <motion.h1 className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-sm sm:text-lg lg:text-2xl font-light tracking-[0.2em] sm:tracking-[0.3em] italic hidden sm:block">
          Botelho Beach House
        </motion.h1>
